...
/// Ukrainian ЙЦУКЕН text layout - primary (Cyrillic letters).
/// Standard Ukrainian keyboard layout used on Windows/Android/iOS.
/// Row 1: й ц у к е н г ш щ з х ї
/// Row 2: ф і в а п р о л д ж є
/// Row 3: я ч с м и т ь б ю (+ shift/backspace)
/// ґ and the apostrophe, which Ukrainian spelling uses inside words, are on
/// the tertiary page.
final KeyboardLayout _textLayoutPrimary = [
  [
    ...
    VirtualKey.character(text: 'ї'),
  ],
  [
    VirtualKey.character(text: 'ф'),
    VirtualKey.character(text: 'і'),
...
/// Ukrainian (ЙЦУКЕН) keyboard language.
final KeyboardLanguage ukrainianLanguage = KeyboardLanguage(
  code: 'uk',
  name: 'Ukrainian',
