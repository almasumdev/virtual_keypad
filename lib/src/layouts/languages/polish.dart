...
/// Polish QWERTY text layout - primary (letters).
/// Standard Polish mobile QWERTY. The nine accented letters live on the
/// tertiary page, as they do for the other Latin layouts here.
...
final KeyboardLayout _textLayoutTertiary = [
  [
    VirtualKey.character(text: 'ą'),
    VirtualKey.character(text: 'ć'),
    VirtualKey.character(text: 'ę'),
    VirtualKey.character(text: 'ł'),
    VirtualKey.character(text: 'ń'),
    VirtualKey.character(text: 'ó'),
    VirtualKey.character(text: 'ś'),
    VirtualKey.character(text: 'ź'),
    VirtualKey.character(text: 'ż'),
    VirtualKey.character(text: '*'),
  ],
  [
...
/// Polish (QWERTY) keyboard language.
final KeyboardLanguage polishLanguage = KeyboardLanguage(
  code: 'pl',
  name: 'Polish',
  nativeName: 'Polski',
